...
# MAGIC <b>Description</b>  : implemented incrementa logic.
...
def get_query4():
  ...
  CASE WHEN FTO.SERVICE_NAME_SR = 'Customer Pickup' THEN FTO.SERVICE_NAME_SR WHEN FTO.SERVICE_NAME_SR = FTO.SERVICE_NAME_LC THEN FTO.CARRIERNAME_LC ELSE FTO.CarrierName END Carrier,          
...
def get_query7():
  ...
  FTO.Account_number,    
  MLB.ShipmentEstimatedDeliveryDate EstimatedDeliveryDateTime,    
