...
WHERE INB.SOURCE_SYSTEM_KEY = 1002)""".format(var_inbound_line_tv=var_inbound_line_tv,var_inbound_tv=var_inbound_tv,**source_tables))
...
def get_query():
 ...
 (CAST(ITEM.ITEM_LENGTH as VARCHAR(1000)) + '*' + CAST(ITEM.ITEM_WIDTH as VARCHAR(1000)) + '*' + CAST(ITEM.ITEM_HEIGHT as VARCHAR(1000) )) as SKUDimensions,  
...
def main():
    ...
    try:
        ...
        hash_key_columns =["AccountId","DP_SERVICELINE_KEY","DP_ORGENTITY_KEY","FacilityId","FacilityCode","UPSOrderNumber","UPSASNNumber","ClientASNNumber","ClientPONumber", 
                            ...
                            "SKUWeight_UOM","SourceSystemKey","InboundLine_Reference2","InboundLine_Reference10","InboundLine_Reference11","PutAwayDate"]
