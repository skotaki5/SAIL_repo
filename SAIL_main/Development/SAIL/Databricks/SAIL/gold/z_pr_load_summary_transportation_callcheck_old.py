...
def get_query():
  ...
  distinct
	...
	,CAST(null as decimal(18,0) ) as TemperatureC  
    ,CAST(null as decimal(18,0) ) as TemperatureF  
    ,CAST(null as int ) as BatteryPercent
    ,CAST(null as int ) as Humidity 
    ,CAST(null as decimal(18,0) ) as Light  
    ,CAST(null as Boolean ) as IsShockExceeded 
    ,CAST(null as decimal(18,0) ) as Latitude  
	,CAST(null as decimal(18,0) ) as Longitude  
	,CAST(null as string ) as DeviceTagId 
	,CAST(null as string ) as LocationMethod 
	,CAST(null as Boolean ) as IsMotionDetected
	,CAST(null as decimal(18,0) ) as Pressure
	,CAST(null as Boolean ) as IsButtonPushed
	,FTO.ORDER_SDUK
