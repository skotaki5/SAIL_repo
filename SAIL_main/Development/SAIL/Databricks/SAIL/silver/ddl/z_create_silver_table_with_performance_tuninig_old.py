...
# %sql
# drop table if exists silver.map_milestone_activity             ;       
# drop table if exists silver.account_type_digital               ;
# drop table if exists silver.local_courier_service              ;
# drop table if exists silver.map_transactiontype_milestone      ;
# drop table if exists silver.map_ordersearchstatus              ;
# drop table if exists silver.wh_wip_mapping_activity            ;
# drop table if exists silver.dim_item                           ;
# drop table if exists silver.dim_source_system                  ;
# drop table if exists silver.dim_warehouse                      ;
# drop table if exists silver.dim_customer                       ;
# drop table if exists silver.dim_carrier_los                    ;
# drop table if exists silver.dim_service                        ;
# drop table if exists silver.dim_geo_location                   ;
# drop table if exists silver.fact_transport_details             ;
# drop table if exists silver.fact_transportation_exception      ;
# drop table if exists silver.fact_transportation_rates_charges  ;
# drop table if exists silver.fact_transportation_references     ;
# drop table if exists silver.fact_transportation_callcheck      ;
# drop table if exists silver.fact_order_line_details            ;
# drop table if exists silver.fact_order_line                    ;
# drop table if exists silver.fact_transportation                ;
# drop table if exists silver.fact_shipment                      ;
# drop table if exists silver.fact_order_reference               ;
# drop table if exists silver.fact_order                         ;
# drop table if exists silver.fact_milestone_activity            ;
# drop table if exists silver.fact_inbound_line                  ;
