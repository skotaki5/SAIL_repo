...
# MAGIC %sql
# MAGIC create external table dim_customer(
...
# MAGIC %sql
# MAGIC create external table dim_warehouse(
...
# MAGIC %sql
# MAGIC 
# MAGIC drop table dim_warehouse

# COMMAND ----------

# MAGIC %sql
# MAGIC CREATE EXTERNAL TABLE dim_item (
...
# MAGIC %sql
# MAGIC 
# MAGIC drop table dim_item

# COMMAND ----------

# MAGIC %sql
# MAGIC CREATE EXTERNAL TABLE dim_carrier_los (
...
# MAGIC %sql
# MAGIC drop table dim_carrier_los

# COMMAND ----------

# MAGIC %sql
# MAGIC CREATE EXTERNAL TABLE dim_service (
...
# MAGIC %sql
# MAGIC drop table dim_service

# COMMAND ----------

# MAGIC %sql
# MAGIC CREATE EXTERNAL TABLE dim_geo_location (
...
# MAGIC %sql
# MAGIC 
# MAGIC drop table dim_geo_location

# COMMAND ----------

# MAGIC %sql
# MAGIC CREATE EXTERNAL TABLE dim_source_system (
# MAGIC 	SOURCE_SYSTEM_KEY INT
...
# MAGIC %sql
# MAGIC 
# MAGIC drop table dim_source_system

# COMMAND ----------

# MAGIC %sql
# MAGIC create external table fact_milestone_activity(
# MAGIC SOURCE_SYSTEM_KEY int
...
# MAGIC %sql
# MAGIC 
# MAGIC drop table fact_milestone_activity

# COMMAND ----------

# MAGIC %sql
# MAGIC create external table fact_order(
# MAGIC  SOURCE_SYSTEM_KEY	int
# MAGIC ,CLIENT_KEY	decimal(18,0)
# MAGIC ,WAREHOUSE_KEY	decimal(18,0)
# MAGIC ,CARRIER_LOS_KEY	decimal(18,0)
...
# MAGIC %sql
# MAGIC 
# MAGIC drop table fact_order

# COMMAND ----------

# MAGIC %sql
# MAGIC create external table fact_transport_details(
# MAGIC SOURCE_SYSTEM_KEY	int
# MAGIC ,CLIENT_KEY	decimal(18,0)
# MAGIC ,WAREHOUSE_KEY	decimal(18,0)
# MAGIC ,ITEM_KEY	decimal(18,0)
...
# MAGIC %sql
# MAGIC 
# MAGIC drop table fact_transport_details

# COMMAND ----------

# MAGIC %sql
# MAGIC create external table fact_transportation(
# MAGIC SOURCE_SYSTEM_KEY	int
# MAGIC ,CLIENT_KEY	decimal(18,0)
# MAGIC ,WAREHOUSE_KEY	decimal(18,0)
# MAGIC ,SERVICE_KEY	decimal(18,0)
...
# MAGIC %sql
# MAGIC 
# MAGIC drop table fact_transportation

# COMMAND ----------

# MAGIC %sql
# MAGIC create external table fact_transportation_rates_charges(
# MAGIC SOURCE_SYSTEM_KEY int
# MAGIC , CLIENT_KEY decimal(18,0)
# MAGIC , LOAD_ID string
# MAGIC , UPS_ORDER_NUMBER string
...
# MAGIC %sql
# MAGIC 
# MAGIC drop table fact_transportation_rates_charges

# COMMAND ----------

# MAGIC %sql
# MAGIC CREATE EXTERNAL TABLE fact_transportation_exception (
# MAGIC 	SOURCE_SYSTEM_KEY INT
# MAGIC 	,UPS_ORDER_NUMBER string
...
# MAGIC %sql
# MAGIC 
# MAGIC drop table fact_transportation_exception

# COMMAND ----------

# MAGIC %sql
# MAGIC CREATE EXTERNAL TABLE fact_transportation_references (
# MAGIC 	SOURCE_SYSTEM_KEY INT
# MAGIC 	,CLIENT_KEY DECIMAL(18, 0)
# MAGIC 	,LOAD_ID string
# MAGIC 	,UPS_ORDER_NUMBER string
...
# MAGIC %sql
# MAGIC 
# MAGIC drop table fact_transportation_references

# COMMAND ----------

# MAGIC %sql
# MAGIC CREATE EXTERNAL TABLE fact_order_line (
# MAGIC 	SOURCE_SYSTEM_KEY INT
# MAGIC 	,CLIENT_KEY DECIMAL(18, 0)
# MAGIC 	,WAREHOUSE_KEY DECIMAL(18, 0)
# MAGIC 	,CARRIER_LOS_KEY DECIMAL(18, 0)
...
# MAGIC %sql
# MAGIC 
# MAGIC drop table fact_order_line

# COMMAND ----------

# MAGIC %sql
# MAGIC CREATE EXTERNAL TABLE fact_order_reference (
# MAGIC 	SOURCE_SYSTEM_KEY INT
# MAGIC 	,UPS_ORDER_NUMBER string
...
# MAGIC %sql
# MAGIC 
# MAGIC drop table fact_order_reference

# COMMAND ----------

# MAGIC %sql
# MAGIC CREATE EXTERNAL TABLE fact_shipment (
# MAGIC 	SOURCE_SYSTEM_KEY INT
...
# MAGIC %sql
# MAGIC 
# MAGIC drop table fact_shipment

# COMMAND ----------

# MAGIC %sql
# MAGIC CREATE EXTERNAL TABLE fact_order_line_details (
# MAGIC 	SOURCE_SYSTEM_KEY INT
# MAGIC 	,CLIENT_KEY DECIMAL(18, 0)
# MAGIC 	,WAREHOUSE_KEY DECIMAL(18, 0)
# MAGIC 	,ITEM_KEY DECIMAL(18, 0)
...
# MAGIC %sql
# MAGIC 
# MAGIC drop table fact_order_line_details

# COMMAND ----------

# MAGIC %sql
# MAGIC create external table fact_transportation_callcheck(
# MAGIC SOURCE_SYSTEM_KEY INT
...
# MAGIC %sql
# MAGIC 
# MAGIC drop table fact_transportation_callcheck

# COMMAND ----------

# MAGIC %sql
# MAGIC create external table map_milestone_activity(
...
# MAGIC %sql
# MAGIC 
# MAGIC drop table map_milestone_activity

# COMMAND ----------

# MAGIC %sql
# MAGIC create external table account_type_digital(
...
# MAGIC %sql
# MAGIC 
# MAGIC drop table account_type_digital

# COMMAND ----------

# MAGIC %sql
# MAGIC create external table local_courier_service(
# MAGIC  ID INT
# MAGIC ,SOURCE_SYSTEM_KEY INT
# MAGIC ,SERVICE_NAME string
...
# MAGIC %sql
# MAGIC 
# MAGIC drop table local_courier_service

# COMMAND ----------

# MAGIC %sql
# MAGIC create external table map_ordersearchstatus(
...
# MAGIC %sql
# MAGIC 
# MAGIC drop table map_ordersearchstatus

# COMMAND ----------

# MAGIC %sql
# MAGIC create external table map_transactiontype_milestone(
# MAGIC 
...
# MAGIC %sql
# MAGIC 
# MAGIC drop table map_transactiontype_milestone
...
# MAGIC 
# MAGIC %sql
# MAGIC create external table fact_inbound_line(
# MAGIC 
# MAGIC SOURCE_SYSTEM_KEY INT
# MAGIC ,CLIENT_KEY DECIMAL(18, 0)
# MAGIC ,WAREHOUSE_KEY DECIMAL(18, 0)
...
# MAGIC %sql
# MAGIC 
# MAGIC drop table fact_inbound_line

# COMMAND ----------

# MAGIC %sql
# MAGIC create external table wh_wip_mapping_activity(
# MAGIC Type string
# MAGIC ,MilestoneName string
# MAGIC ,ActivityName string
# MAGIC ,ActivityCode string
...
# MAGIC %sql
# MAGIC 
# MAGIC drop table wh_wip_mapping_activity

# COMMAND ----------

# MAGIC %sql
# MAGIC create external table fact_inventory_snapshot(
# MAGIC     SOURCE_SYSTEM_KEY INT ,
# MAGIC 	CLIENT_KEY DECIMAL(18, 0) ,
# MAGIC 	WAREHOUSE_KEY DECIMAL(18, 0) ,
# MAGIC 	ITEM_KEY DECIMAL(18, 0) ,
...
# MAGIC %sql
# MAGIC 
# MAGIC drop table fact_inventory_snapshot

# COMMAND ----------

df =  spark.read.option("inferSchema" ,True).parquet("/mnt/sail/bronze/gld360/inbound/landing/wh_wip_mapping_activity/")
