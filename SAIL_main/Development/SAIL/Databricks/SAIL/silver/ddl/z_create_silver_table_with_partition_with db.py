...
# %sql
# drop table silver.map_milestone_activity             ;       
# drop table silver.account_type_digital               ;
# drop table silver.local_courier_service              ;
# drop table silver.map_transactiontype_milestone      ;
# drop table silver.map_ordersearchstatus              ;
# drop table silver.wh_wip_mapping_activity            ;
# drop table silver.dim_item                           ;
# drop table silver.dim_source_system                  ;
# drop table silver.dim_warehouse                      ;
# drop table silver.dim_customer                       ;
# drop table silver.dim_carrier_los                    ;
# drop table silver.dim_service                        ;
# drop table silver.dim_geo_location                   ;
# drop table silver.fact_transport_details             ;
# drop table silver.fact_transportation_exception      ;
# drop table silver.fact_transportation_rates_charges  ;
# drop table silver.fact_transportation_references     ;
# drop table silver.fact_transportation_callcheck      ;
# drop table silver.fact_order_line_details            ;
# drop table silver.fact_order_line                    ;
# drop table silver.fact_transportation                ;
# drop table silver.fact_shipment                      ;
# drop table silver.fact_order_reference               ;
# drop table silver.fact_order                         ;
# drop table silver.fact_milestone_activity            ;
# drop table silver.fact_inbound_line                  ;
# drop table silver.fact_inventory_snapshot     ;